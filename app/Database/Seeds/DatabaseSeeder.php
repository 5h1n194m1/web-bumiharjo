    ...
    public function run()
    {
        ...
        if (! $siteSettingModel->first()) {
            $siteSettingModel->insert([
                ...
                'services_label' => 'Fasilitas',
                'services_title' => 'Fasilitas',
                'services_intro' => 'Rangkaian fasilitas yang disusun untuk tamu yang datang mencari kenyamanan, kebersamaan, maupun kebutuhan acara yang berkesan.',
                'gallery_label' => 'Galeri',
                'gallery_title' => 'Keindahan yang terasa dekat dan tenang.',
                'gallery_intro' => 'Sudut visual Balkondes Bumiharjo untuk penginapan, acara, dan nuansa desa wisata.',
        ...
        if ($heroSlideModel->countAllResults() === 0) {
            $heroSlideModel->insert([
                ...
                'subtitle' => 'Tempat singgah hangat dekat Borobudur untuk penginapan, acara, dan nuansa desa wisata.',
